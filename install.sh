...
echo ""
echo "  Analysis:"
echo "    /health        - Project health check"
echo "    /refactor      - Find refactoring opportunities"
echo "    /unused        - Find unused code & deps"
echo "    /deps          - Update dependencies"
echo "    /todo-scan     - Find TODO/FIXME markers"
echo ""
echo "  Prompting:"
echo "    /prompt-audit  - Audit prompts for anti-patterns"
echo "    /prompt-create - Guide for writing new agent prompts"
echo ""
echo "  Context:"
